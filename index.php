...
if ($_SESSION['id_tipo_usuario'] == 1) {  // Administrador
    $is_admin = true;
} else {  // Usuario normal
    $is_admin = false;
}
...
<body>
    ...
    <div class="container">
        <div id="mainContent" class="dashboard-header">
            ...
            <?php if ($is_admin): ?>
                <p>Este es el panel de administración. Puedes gestionar usuarios, tipos de usuarios y el cotizador.</p>
            <?php else: ?>
                <p>Este es tu panel de usuario. Puedes acceder al cotizador.</p>
            <?php endif; ?>
        </div>
    </div>
